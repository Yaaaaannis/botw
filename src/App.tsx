      ...
      <div className="relative z-20 flex flex-col min-h-screen">
        ...
        <main className="flex-1 flex flex-col items-center justify-start text-center p-28  ">
          ...
          <div className="flex gap-4 justify-center">
            <button className="cta-btn bg-white text-black font-semibold pt-[10px] pr-[56px] pb-[10px] pl-[56px] rounded-[8px] shadow hover:bg-gray-200 flex items-center gap-2 font-pp">
